...
public class MyModelCreeper extends ModelBase
{
    public ModelRenderer head;
    public ModelRenderer headswell;
    ...
    public MyModelCreeper()
    {
        this(0.0F);
    }

    public MyModelCreeper(float par1)
    {
        byte b0 = 4;
        this.head = new ModelRenderer(this, 0, 0);
        this.head.addBox(-4.0F, -8.0F, -4.0F, 8, 8, 8, par1);
        this.head.setRotationPoint(0.0F, (float)b0, 0.0F);
        this.headswell = new ModelRenderer(this, 32, 0);
        this.headswell.addBox(-4.0F, -8.0F, -4.0F, 8, 8, 8, par1 + 0.5F);
        this.headswell.setRotationPoint(0.0F, (float)b0, 0.0F);
